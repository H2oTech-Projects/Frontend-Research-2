...
const Register = () => {
  ...
  return (
    <AuthenticationCard
      ...
      children={
        <div className={cn("flex flex-col items-center gap-4", isDesktopDevice ? "px-6 pb-4 " : "px-3 pt-5")}>
         ...
         <form onSubmit={formik.handleSubmit} className="mt-2 space-y-3">
                    ...
                    <button
                        type="submit"
                        className="w-full rounded-lg bg-blue-500 p-1 text-white hover:bg-blue-600"
                    >
                        Register
                    </button>
                    <Link
