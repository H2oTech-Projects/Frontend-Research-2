...
import { GET_CLIENT_LIST_KEY, GET_CLIENT_MAP_GEOJSON_KEY } from '@/services/client/constant';
...
const Clients = () => {
  ...
  const { data: mapGeoJson, isLoading: isMapLoading } = useGetClientMapGeoJson();
