...
const clientSchema = z.object({
  ...
  client_country: z.string().length(2).optional(),
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className='bg-white rounded-lg shadow-md p-5 mt-3 h-auto flex flex-col gap-4 dark:bg-slate-900 dark:text-white'>
          <div className='grid grid-cols-2 gap-4 mb-4'>
            <div className='flex flex-col gap-2'>
              <FormInput control={form.control} name='client_ha' label='Client Acreage' placeholder='Enter Client Acreage ' type='text' showLabel={true} />
