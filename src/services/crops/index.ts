...
import { GET_ALL_CROP_FIELDS_LIST, GET_ALL_CROP_FIELDS_MAP, GET_BY_ID_CROP_FIELD, GET_CROPS_LIST, POST_CROPS, PUT_CROPS, DELETE_CROPS, PUT_CROPS_FIELD, CROP_GROUPNAME_DROPDOWN  } from "./constants";
...
export const useGetCropGroupNameDropdown = ():UseQueryResult<any> => {
  return useQuery({
    queryKey: [CROP_GROUPNAME_DROPDOWN],
